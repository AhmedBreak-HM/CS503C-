...
int main()
{
    int board[NUMBER_OF_ROWS][NUMBER_OF_COLUMNS] = {
        {23, 5, 6, 15, 18}, {4, 16, 24, 67, 10}, {12, 54, 23, 76, 11}, {1, 12, 34, 22, 8}, {81, 54, 32, 67, 33}, {12, 34, 76, 78, 9}};
...
{
    int row, col, sum;
    for (row = 0; row < NUMBER_OF_ROWS; row++) //Sum of each individual row
    {
        sum = 0;
        for (col = 0; col < NUMBER_OF_COLUMNS; col++)
...
/*            From 47 to 55
    ...
    • Declares a two dimension array of type int and consists of 10 rows and 10
    columns.
    • Uses functions in your program to achieve the following:
    1. Initialize it to zeros
    2. Read it from the user
    3. Print it
    4. Find the smallest element in it
    5. Find the sum of each individual row.

    Please note that I want a complete program that includes the definition of the
    previous functions and call them.
